...
const Home = () =>
{
    return (
        <div className="Homecontainer">
            ...
            <div>
            <img src="https://tse3.mm.bing.net/th?id=OIP.ilIaDOjE7AshYnN7INUiugHaEK&pid=Api&P=0&w=279&h=158"alt="imae"/>
            ...
            <p>Height: 5'10" (1.77m)</p>
            <p>Net worth: ),<span style={{color:'blue'}}>$148 billion (celebritynetworth.com)</span></p>
            </div>
            </div>
